<template>
  ...
  <div class="meng" v-bind:class="{ meng1: !show }" @click="onHide(false)"></div>
...
<script>
  ...
  import array2string from '../libs/filters/array2String'
...
<style>
  ...
  .vux-popup-picker-header .vux-flexbox-item{
    width:50% !important;
  }
</style>
