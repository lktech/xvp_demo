...
<div class="addinfo">
    ...
    <c-group>   
        ...
        <c-input title="客服电话" @on-change="validate" placeholder="请输入客服电话" name="phone" required v-model="formData.phone" :max="30" :is-type="kong"></c-input>
        <c-input title="QQ号码 " @on-change="validate" placeholder="请输入QQ号码(选填)" name="QQ" v-model="formData.QQ" :max="20" :is-type="kong"></c-input>
    </c-group>
