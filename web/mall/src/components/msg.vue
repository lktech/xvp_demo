<template>
    <div class="weui_msg">
        ...
        <div class="weui_text_area">
            ...
            <div class="money" v-if="score">{{score}}积分</div>
            <div class="label9-small" v-if="thirdtext">{{thirdtext}}</div>
        </div>
        <slot name="list"></slot>
...
<script>
    export default{
        props: ['status','msg','money','desc','score','thirdtext','msgColor']
    }
</script>
...
<style lang="less">
    ...
    @import '../assets/styles/weui/widget/weui_page/weui_msg.less';
    @import "../assets/styles/components/msg.less";
</style>