...
<script>
import name2value from '../../libs/components/filters/name2value'
import value2name from '../../libs/components/filters/value2name'
import PopupPicker from '../popup-picker/popup-picker.vue'
...
export default {
  ...
  watch: {
    ...
    value (val) {
      ...
      this.$emit('getname', value2name(this.currentValue, this.list));
    }
  }
}
</script>
