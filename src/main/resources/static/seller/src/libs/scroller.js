...
import { getElement, getComputedStyle, easeOutCubic, easeInOutCubic } from './picker-util'
...
var members = {
  ...
  __startDeceleration (timeStamp) {
    ...
    // If we are already slow enough to not being warehouse perceivable anymore, we stop the whole process here.
    var verify = function () {
